...
namespace Amendieres::Gfx
{
    ...
    public:
        ...
        //DynamicFont stuff
        virtual uint64_t DynamicFont_Create(DynamicFont* const inst, const char* const fontFileData, const uint64_t dataLength) = 0;
        virtual uint64_t DynamicFont_Create(DynamicFont* const inst, const char* const fontFileData, const uint64_t dataLength, const uint8_t renderSize) = 0;
