...
TARGET=amendieres
SRCS=main.cpp Json/JsonParser.cpp Json/JsonNode.cpp AssetManager.cpp AssetBase.cpp Json/JsonAsset.cpp Gfx/RenderServerAPI.cpp Gfx/WindowServerAPI.cpp Gfx/Colour.cpp
